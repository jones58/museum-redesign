...
// node_modules/mondaine-clock-react/dist/esm/components/mondaine-clock.js
var import_react = __toESM(require_react());
var TickType;
(function(TickType2) {
  TickType2[TickType2["MECHANICAL"] = 0] = "MECHANICAL";
  TickType2[TickType2["QUARTZ"] = 1] = "QUARTZ";
})(TickType || (TickType = {}));
var ONE_SECOND = 1e3;
...
function MondaineClock(props) {
  ...
  var _m = (0, import_react.useState)(fixedDate ? fixedDate : /* @__PURE__ */ new Date()), time = _m[0], setTime = _m[1];
  ...
  var renderHourHand = function() {
    ...
    return import_react.default.createElement(
      "g",
      null,
      import_react.default.createElement("polygon", { points: "47.4,18 52.6,18 53.2,62 46.8,62", transform: rotation, fill: hoursHandColor })
    );
  };
  var renderMinuteHandSwiss = function() {
    ...
    if (tickType === TickType.QUARTZ) {
      ...
      rotation = "rotate(".concat(360 / 60 * (Number(minutes) + 0.8), ", 50, 50)");
    } else if (seconds > 59.9) {
    ...
    return import_react.default.createElement(
      "g",
      null,
      import_react.default.createElement("polygon", { points: "48.2,4 51.8,4 52.6,62 47.4,62", transform: rotation, fill: minutesHandColor })
    );
  };
  var renderSecondHand = function() {
    ...
    return import_react.default.createElement(
      "g",
      { fill: secondsHandColor, transform: rotation },
      import_react.default.createElement("rect", { x: 49.3, y: 18.8, width: 1.4, height: 47.7 }),
      import_react.default.createElement("circle", { cx: 50, cy: 18.8, r: 5.25, strokeWidth: 0 }),
      showCenterDot && import_react.default.createElement(
        import_react.default.Fragment,
        null,
        import_react.default.createElement("circle", { cx: 50, cy: 50, r: 1.5, strokeWidth: 0 })
      )
    );
  };
...
//# sourceMappingURL=mondaine-clock-react.js.map
